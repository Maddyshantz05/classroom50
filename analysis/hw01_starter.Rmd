...
-   `country_2021.csv`: Contains information on the countries in the data set. The variables are:
...
-   `fertility_rate_2020.csv`: Contains the fertility rate information for each country for each year.
...
-   `life_expectancy_2020.csv`: Contains the life expectancy information for each country for each year.
...
-   `population_2021.csv`: Contains the population information for each country.
